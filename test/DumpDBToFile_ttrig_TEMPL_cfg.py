...
process.calibDB = cms.ESSource("PoolDBESSource",
    ...
    connect = cms.string('sqlite_file:/afs/cern.ch/cms/CAF/CMSALCA/ALCA_MUONCALIB/DTCALIB/RUNPERIODTEMPL/ttrig/ttrig_DUMPDBTEMPL_TEMPLATE.db')
...
process.dumpToFile = cms.EDFilter("DumpDBToFile",
    ...
    outputFileName = cms.untracked.string('/afs/cern.ch/cms/CAF/CMSALCA/ALCA_MUONCALIB/DTCALIB/RUNPERIODTEMPL/ttrig/ttrig_DUMPDBTEMPL_TEMPLATE.txt')
